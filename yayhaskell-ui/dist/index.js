...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "a" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-center" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])((function () {
      ...
      throw new Error("Failed pattern match at Grid.A (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.A (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var showStatus = new Data_Show.Show(function (v) {
      ...
      if (v instanceof Discussion) {
          return "Discussion";
      };
      if (v instanceof Accepted) {
          return "Accepted";
      };
      throw new Error("Failed pattern match at Grid.B (line 20, column 1 - line 23, column 31): " + [ v.constructor.name ]);
  });
  var renderStatusBar = function (dictShow) {
      return function (v) {
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("prop-status-bar") ])([ Halogen_HTML_Core.text(v.value0 + (" " + Data_Show.show(dictShow)(v.value1))) ]);
      };
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  ...
  var handleAction = function (v) {
      if (v instanceof Toggle) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
              var $16 = {};
              for (var $17 in oldState) {
                  if ({}.hasOwnProperty.call(oldState, $17)) {
                      $16[$17] = oldState[$17];
                  };
              };
              $16.isActive = !oldState.isActive;
              return $16;
          }))(function () {
              return Halogen_Query_HalogenM.raise(Data_Unit.unit);
          });
      ...
      if (v instanceof RecieveInput) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
              var $19 = {};
              for (var $20 in oldState) {
                  if ({}.hasOwnProperty.call(oldState, $20)) {
                      $19[$20] = oldState[$20];
                  };
              };
              $19.isActive = v.value0;
              return $19;
          });
      };
      throw new Error("Failed pattern match at Grid.B (line 79, column 16 - line 84, column 59): " + [ v.constructor.name ]);
  };
  var eqStatus = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Discussion && y instanceof Discussion) {
              return true;
          };
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "b" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-center" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("prop-status-list") ])((function () {
              var $26 = Data_Eq.eq(Data_Eq.eqArray(Data_Tuple.eqTuple(Data_Eq.eqString)(eqStatus)))(state.proposals)([  ]);
              if ($26) {
                  return [ Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Core.text("No proposals") ]) ];
              };
              return Data_Functor.map(Data_Functor.functorArray)(renderStatusBar(showStatus))(state.proposals);
          })()) ]);
      };
      throw new Error("Failed pattern match at Grid.B (line 58, column 16 - line 76, column 14): " + [ state.isActive.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "c" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.C (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.C (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "d" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "e" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.E (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.E (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "f" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.F (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.F (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Grid.Free"] = $PS["Grid.Free"] || {};
  var exports = $PS["Grid.Free"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
  var render = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("grid-item") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("This is text in a span!") ]) ]) ]);
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "g" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.G (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.G (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "h" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.H (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.H (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "i" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.I (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.I (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "j" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.J (line 66, column 16 - line 81, column 101): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.J (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "k" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.K (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.K (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "l" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Click to Expand") ]) ]);
      };
      if (state.isActive) {
      ...
      throw new Error("Failed pattern match at Grid.L (line 66, column 16 - line 81, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.L (line 84, column 16 - line 89, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var Grid_F = $PS["Grid.F"];
  var Grid_Free = $PS["Grid.Free"];
  var Grid_G = $PS["Grid.G"];
  var Grid_H = $PS["Grid.H"];
  var Grid_I = $PS["Grid.I"];
  var Grid_J = $PS["Grid.J"];
  var Grid_K = $PS["Grid.K"];
  var Grid_L = $PS["Grid.L"];
  var Halogen_Component = $PS["Halogen.Component"];
  ...
  var ToggleG = (function () {
      ...
      ToggleG.value = new ToggleG();
      return ToggleG;
  })();
  var ToggleH = (function () {
      function ToggleH() {

      };
      ToggleH.value = new ToggleH();
      return ToggleH;
  })();
  var ToggleI = (function () {
      function ToggleI() {

      };
      ToggleI.value = new ToggleI();
      return ToggleI;
  })();
  var ToggleJ = (function () {
      function ToggleJ() {

      };
      ToggleJ.value = new ToggleJ();
      return ToggleJ;
  })();
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          ...
          if (v instanceof ToggleB) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $22 = {};
                  for (var $23 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $23)) {
                          $22[$23] = oldState[$23];
                      };
                  };
                  $22.aIsActive = false;
          ...
          if (v instanceof ToggleD) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $28 = {};
                  for (var $29 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $29)) {
                          $28[$29] = oldState[$29];
                      };
                  };
                  $28.aIsActive = false;
          ...
          if (v instanceof ToggleE) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $31 = {};
                  for (var $32 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $32)) {
                          $31[$32] = oldState[$32];
                      };
                  };
                  $31.aIsActive = false;
          ...
          if (v instanceof ToggleF) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $34 = {};
                  for (var $35 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $35)) {
                          $34[$35] = oldState[$35];
                      };
                  };
                  $34.aIsActive = false;
          ...
          if (v instanceof ToggleH) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $43 = {};
                  for (var $44 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $44)) {
                          $43[$44] = oldState[$44];
                      };
                  };
                  $43.aIsActive = false;
          ...
          if (v instanceof ToggleI) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $46 = {};
                  for (var $47 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $47)) {
                          $46[$47] = oldState[$47];
                      };
                  };
                  $46.aIsActive = false;
          ...
          if (v instanceof ToggleJ) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $49 = {};
                  for (var $50 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $50)) {
                          $49[$50] = oldState[$50];
                      };
                  };
                  $49.aIsActive = false;
          ...
          if (v instanceof ToggleK) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $52 = {};
                  for (var $53 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $53)) {
                          $52[$53] = oldState[$53];
                      };
                  };
                  $52.aIsActive = false;
          ...
          if (v instanceof ToggleL) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $55 = {};
                  for (var $56 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $56)) {
                          $55[$56] = oldState[$56];
                      };
                  };
                  $55.aIsActive = false;
          ...
          throw new Error("Failed pattern match at Grid (line 149, column 16 - line 344, column 27): " + [ v.constructor.name ]);
      };
  };
  var _l = Data_Symbol.SProxy.value;
  var _k = Data_Symbol.SProxy.value;
  var _j = Data_Symbol.SProxy.value;
  var _i = Data_Symbol.SProxy.value;
  var _h = Data_Symbol.SProxy.value;
  var _g = Data_Symbol.SProxy.value;
  var _free = Data_Symbol.SProxy.value;
  var _f = Data_Symbol.SProxy.value;
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.main([ Halogen_HTML_Properties.class_("grid-container") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          ...
          return "e";
      }))(Data_Ord.ordInt)(_e)(5)(Grid_E.component)(state.eIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleE.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "f";
      }))(Data_Ord.ordInt)(_f)(6)(Grid_F.component)(state.fIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleF.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "g";
      }))(Data_Ord.ordInt)(_g)(7)(Grid_G.component)(state.gIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleG.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "h";
      }))(Data_Ord.ordInt)(_h)(8)(Grid_H.component)(state.hIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleH.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "i";
      }))(Data_Ord.ordInt)(_i)(9)(Grid_I.component)(state.iIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleI.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "j";
      }))(Data_Ord.ordInt)(_j)(10)(Grid_J.component)(state.jIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleJ.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "k";
      }))(Data_Ord.ordInt)(_k)(11)(Grid_K.component)(state.kIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleK.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "l";
      }))(Data_Ord.ordInt)(_l)(12)(Grid_L.component)(state.lIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleL.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "free";
      }))(Data_Ord.ordInt)(_free)(13)(Grid_Free.component(Grid_Free.render))(Data_Unit.unit)(Data_Void.absurd) ]);
  };
...
(function($PS) {
  ...
  var IsLight = (function () {
      function IsLight(value0) {
          this.value0 = value0;
      };
      IsLight.create = function (value0) {
          return new IsLight(value0);
      };
      return IsLight;
  })();
  var Toggled = (function () {
  ...
  var handleQuery = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (val) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0(val)));
      });
  };
  var handleAction = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
          ...
          $9.isLight = !st.isLight;
          return $9;
      }))(function (newState) {
          return Halogen_Query_HalogenM.raise(new Toggled(newState.isLight));
      });
  };
...
(function($PS) {
  ...
  var CheckButtonState = (function () {
      ...
      CheckButtonState.value = new CheckButtonState();
  ...
  var renderListHeader = function (x) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("logo") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link"), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "link-text", "logo-text" ]) ])([ Halogen_HTML_Core.text("Yay") ]), Svg_Renderer_Halogen.icon(x)([ className("icon") ]) ]) ]);
  };
  var renderListItem = function (v) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link"), Halogen_HTML_Properties.href("#") ])([ Svg_Renderer_Halogen.icon(v.value0)([ className("icon") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("link-text") ])([ Halogen_HTML_Core.text(v.value1) ]) ]) ]);
  };
  var _switch = Data_Symbol.SProxy.value;
  var handleAction = function (v) {
      if (v instanceof HandleSwitch) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
      };
      if (v instanceof CheckButtonState) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
              return "switch";
          }))(Data_Ord.ordUnit)(_switch)(Data_Unit.unit)(Halogen_Query.request(Navbar_Switch.IsLight.create)))(function (switchState) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $11.switchState = switchState;
                  return $11;
              });
          });
      };
      throw new Error("Failed pattern match at Navbar (line 84, column 16 - line 89, column 48): " + [ v.constructor.name ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_("navbar") ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("navbar-nav") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.cons(renderListHeader(logo1))(Data_Functor.map(Data_Functor.functorArray)(renderListItem)([ new Data_Tuple.Tuple(logo1, "Home"), new Data_Tuple.Tuple(logo1, "News"), new Data_Tuple.Tuple(logo1, "Blog") ])))([ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "switch";
      }))(Data_Ord.ordUnit)(_switch)(Data_Unit.unit)(Navbar_Switch.component)(Data_Unit.unit)(function ($14) {
          return Data_Maybe.Just.create(HandleSwitch.create($14));
      }) ]) ])) ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
...
(function($PS) {
  ...
  var main = (function () {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Navbar.component)(Data_Unit.unit)(body))(function () {
