...
(function($PS) {
  ...
  var testProps = [ new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Dependent Types", Discussion.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value) ];
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  var initialState = function (input) {
  ...
  var handleAction = function (v) {
      if (v instanceof Toggle) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
              var $12 = {};
              for (var $13 in oldState) {
                  if ({}.hasOwnProperty.call(oldState, $13)) {
                      $12[$13] = oldState[$13];
                  };
              };
              $12.isActive = !oldState.isActive;
              return $12;
          }))(function () {
              return Halogen_Query_HalogenM.raise(Data_Unit.unit);
          });
      ...
      if (v instanceof RecieveInput) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
              var $15 = {};
              for (var $16 in oldState) {
                  if ({}.hasOwnProperty.call(oldState, $16)) {
                      $15[$16] = oldState[$16];
                  };
              };
              $15.isActive = v.value0;
              return $15;
          });
      };
      throw new Error("Failed pattern match at Grid.D (line 191, column 16 - line 196, column 59): " + [ v.constructor.name ]);
  };
  ...
  var chooseSvg = function (status) {
      ...
      throw new Error("Failed pattern match at Grid.D (line 144, column 20 - line 147, column 24): " + [ status.constructor.name ]);
  };
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "d" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("GHC Proposals Status") ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "prop-status-list" ]) ])(Data_Functor.map(Data_Functor.functorArray)(renderStatusBar)(state.proposals)) ]);
      };
      if (state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item", "d" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
      ...
      throw new Error("Failed pattern match at Grid.D (line 164, column 16 - line 188, column 14): " + [ state.isActive.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Grid (line 149, column 16 - line 209, column 27): " + [ v.constructor.name ]);
      };
  };
