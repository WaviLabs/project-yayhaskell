...
(function($PS) {
  ...
  var icon = function (input) {
      return function (attrs) {
          var v = Svg_Parser.parseToSvgNode(input);
          if (v instanceof Data_Either.Right && v.value0 instanceof Svg_Parser.SvgElement) {
              return svgElementToHtmlWithAttrs(v.value0.value0)(attrs);
          };
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("style")("color: red;") ])([ Halogen_HTML_Core.text("!SVG Parse Failed!") ]);
      };
  };
  exports["icon"] = icon;
})(PS);
(function($PS) {
  ...
  var mkIcon = Svg_Renderer_Halogen.icon;
  var className = Halogen_HTML_Properties.attr("class");
  exports["className"] = className;
  exports["mkIcon"] = mkIcon;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Grid.A"] = $PS["Grid.A"] || {};
  var exports = $PS["Grid.A"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var RecieveInput = (function () {
      function RecieveInput(value0) {
          this.value0 = value0;
      };
      RecieveInput.create = function (value0) {
          return new RecieveInput(value0);
      };
      return RecieveInput;
  })();
  ...
  var render = function (state) {
      ...
      if (state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item-center" ]), Halogen_HTML_Events.onClick(function (v) {
              ...
              var $8 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "link";
                  ...
                  return "author";
              }))(Data_Eq.eqString))))(state.posts)([  ]);
              if ($8) {
                  return [ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("No Posts") ]) ];
              };
              return Data_Functor.map(Data_Functor.functorArray)(renderPost(Data_Show.showInt))(state.posts);
          })());
      };
      throw new Error("Failed pattern match at Grid.A (line 70, column 16 - line 87, column 102): " + [ state.isActive.constructor.name ]);
  };
  ...
  var handleAction = function (v) {
      if (v instanceof Toggle) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
              var $10 = {};
              for (var $11 in oldState) {
                  if ({}.hasOwnProperty.call(oldState, $11)) {
                      $10[$11] = oldState[$11];
                  };
              };
              $10.isActive = !oldState.isActive;
              return $10;
          }))(function () {
              return Halogen_Query_HalogenM.raise(Data_Unit.unit);
          });
      };
      if (v instanceof RecieveInput) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
              var $13 = {};
              ...
              $13.isActive = v.value0;
              return $13;
          });
      };
      throw new Error("Failed pattern match at Grid.A (line 90, column 16 - line 95, column 59): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("Learn Haskell") ]), Icon.mkIcon(svg)([ Icon.className("brain-icon") ]) ]);
      };
      if (state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item-center" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
      ...
      throw new Error("Failed pattern match at Grid.B (line 70, column 16 - line 87, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.B (line 90, column 16 - line 95, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var render = function (state) {
      if (!state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
          }) ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("Fix Issues") ]), Icon.mkIcon(svg)([ Icon.className("fix-icon") ]) ]);
      };
      if (state.isActive) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item-center" ]), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Toggle.value);
              ...
              if ($8) {
                  return [ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("No Posts") ]) ];
              };
              return Data_Functor.map(Data_Functor.functorArray)(renderPost(Data_Show.showInt))(state.posts);
          })());
      };
      throw new Error("Failed pattern match at Grid.C (line 69, column 16 - line 86, column 102): " + [ state.isActive.constructor.name ]);
  };
  var receive = function (input) {
      return Data_Maybe.Just.create(new RecieveInput(input));
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Grid.C (line 89, column 16 - line 94, column 59): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  ...
  var warning = "<svg height=\"30px\" width=\"30px\" xmlns=\"http://www.w3.org/2000/svg\" id=\"Capa_1\" enable-background=\"new 0 0 512 512\" viewBox=\"0 0 512 512\"><g><path d=\"m496.906 215.009c-61.306-71.971-127.944-138.609-199.915-199.915-23.627-20.126-58.354-20.126-81.981 0-71.972 61.306-138.61 127.944-199.916 199.915-20.126 23.627-20.126 58.354 0 81.981 61.306 71.972 127.944 138.61 199.915 199.916 23.627 20.126 58.354 20.126 81.981 0 71.972-61.306 138.61-127.944 199.916-199.915 20.125-23.628 20.125-58.354 0-81.982z\" fill=\"#665e66\"/><path d=\"m237.822 496.908c8.726 7.428 18.955 12.115 29.587 14.052-18.172 3.327-37.488-1.36-52.395-14.052-71.979-61.306-138.611-127.949-199.917-199.917-20.13-23.632-20.13-58.35 0-81.982 61.306-71.968 127.938-138.611 199.917-199.917 14.907-12.692 34.223-17.379 52.395-14.052-10.632 1.937-20.861 6.624-29.587 14.052-71.968 61.306-138.61 127.949-199.917 199.917-20.119 23.632-20.119 58.35 0 81.982 61.307 71.968 127.949 138.611 199.917 199.917z\" fill=\"#544f57\"/><path d=\"m256 473.883c-5.956 0-11.735-2.129-16.274-5.994-70.095-59.706-135.909-125.52-195.615-195.615-8.033-9.43-8.033-23.118-.001-32.548 59.706-70.095 125.521-135.909 195.615-195.615 4.539-3.866 10.318-5.995 16.274-5.995s11.735 2.129 16.274 5.994c70.095 59.706 135.909 125.52 195.615 195.615 8.033 9.43 8.033 23.118 0 32.548-59.706 70.095-125.521 135.909-195.615 195.615-4.538 3.867-10.317 5.995-16.273 5.995z\" fill=\"#ffef4a\"/><g fill=\"#665e66\"><path d=\"m248.63 135.341c4.914-.357 9.827-.357 14.741 0 12.14.882 21.7 10.761 22.086 22.927 1.16 36.604 1.16 73.208 0 109.812-.385 12.166-9.946 22.045-22.086 22.927-4.914.357-9.827.357-14.741 0-12.14-.882-21.7-10.761-22.086-22.927-1.16-36.604-1.16-73.208 0-109.812.386-12.166 9.946-22.045 22.086-22.927z\"/><path d=\"m248.981 315.305c4.679-.128 9.358-.128 14.037 0 12.689.347 22.849 10.534 23.202 23.223.14 5.027.14 10.053 0 15.08-.354 12.689-10.513 22.876-23.202 23.223-4.679.128-9.358.128-14.037 0-12.689-.347-22.849-10.534-23.202-23.223-.14-5.027-.14-10.053 0-15.08.354-12.689 10.513-22.876 23.202-23.223z\"/></g></g></svg>";
  var testProps = [ new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Dependent Types", Discussion.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dynamic Types", Rejected.value), new Data_Tuple.Tuple("Dot Syntax", Accepted.value), new Data_Tuple.Tuple("Linear Types", Discussion.value) ];
  var prevSvg = "<svg width=\"2rem\" height=\"2rem\" xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" data-prefix=\"fas\" data-icon=\"arrow-left\" class=\"svg-inline--fa fa-arrow-left fa-w-14\" role=\"img\" viewBox=\"0 0 448 512\"><path fill=\"currentColor\" d=\"M257.5 445.1l-22.2 22.2c-9.4 9.4-24.6 9.4-33.9 0L7 273c-9.4-9.4-9.4-24.6 0-33.9L201.4 44.7c9.4-9.4 24.6-9.4 33.9 0l22.2 22.2c9.5 9.5 9.3 25-.4 34.3L136.6 216H424c13.3 0 24 10.7 24 24v32c0 13.3-10.7 24-24 24H136.6l120.5 114.8c9.8 9.3 10 24.8.4 34.3z\"/></svg>";
  var nextSvg = "<svg width=\"2rem\" height=\"2rem\" xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" data-prefix=\"fas\" data-icon=\"arrow-right\" class=\"svg-inline--fa fa-arrow-right fa-w-14\" role=\"img\" viewBox=\"0 0 448 512\"><path fill=\"currentColor\" d=\"M190.5 66.9l22.2-22.2c9.4-9.4 24.6-9.4 33.9 0L441 239c9.4 9.4 9.4 24.6 0 33.9L246.6 467.3c-9.4 9.4-24.6 9.4-33.9 0l-22.2-22.2c-9.5-9.5-9.3-25 .4-34.3L311.4 296H24c-13.3 0-24-10.7-24-24v-32c0-13.3 10.7-24 24-24h287.4L190.9 101.2c-9.8-9.3-10-24.8-.4-34.3z\"/></svg>";
  var initialState = function (v) {
      var numOfProposals = Data_Array.length(testProps);
      return {
          proposals: testProps,
          pageSize: 10,
          currentPage: 1,
          lastPage: Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(numOfProposals)(10) + (function () {
              var $12 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(numOfProposals)(10) === 0;
              if ($12) {
                  return 0;
              };
              return 1;
  ...
  var handleAction = function (v) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              var newState = (function () {
                  ...
                  if ($14) {
                      ...
                      $15.currentPage = state.currentPage - 1 | 0;
                      return $15;
                  };
                  return state;
              })();
      ...
      if (v instanceof NextPage) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              var newState = (function () {
                  var $18 = state.currentPage < state.lastPage;
                  if ($18) {
                      var $19 = {};
                      for (var $20 in state) {
                      ...
                      $19.currentPage = state.currentPage + 1 | 0;
                      return $19;
                  };
                  return state;
              })();
      ...
      throw new Error("Failed pattern match at Grid.E (line 156, column 16 - line 165, column 19): " + [ v.constructor.name ]);
  };
  var getProposalsPage = function (state) {
      return Data_Array.take(10)(Data_Array.drop(10 * (state.currentPage - 1 | 0) | 0)(state.proposals));
  };
  var fail = "<svg height=\"30px\" width=\"30px\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" version=\"1.1\" id=\"Layer_1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 512 512\" style=\"enable-background:new 0 0 512 512;\" xml:space=\"preserve\">\x0a<ellipse style=\"fill:#E21B1B;\" cx=\"256\" cy=\"256\" rx=\"256\" ry=\"255.832\"/>\x0a<g>\x0a\x0a\x09\x09<rect x=\"228.021\" y=\"113.143\" transform=\"matrix(0.7071 -0.7071 0.7071 0.7071 -106.0178 256.0051)\" style=\"fill:#FFFFFF;\" width=\"55.991\" height=\"285.669\"/>\x0a\x0a\x09\x09<rect x=\"113.164\" y=\"227.968\" transform=\"matrix(0.7071 -0.7071 0.7071 0.7071 -106.0134 255.9885)\" style=\"fill:#FFFFFF;\" width=\"285.669\" height=\"55.991\"/>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a</svg>";
  var check = "<svg height=\"30px\" width=\"30px\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" version=\"1.1\" id=\"Capa_1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 367.805 367.805\" style=\"enable-background:new 0 0 367.805 367.805;\" xml:space=\"preserve\">\x0a<g>\x0a\x09<path style=\"fill:#3BB54A;\" d=\"M183.903,0.001c101.566,0,183.902,82.336,183.902,183.902s-82.336,183.902-183.902,183.902   S0.001,285.469,0.001,183.903l0,0C-0.288,82.625,81.579,0.29,182.856,0.001C183.205,0,183.554,0,183.903,0.001z\"/>\x0a\x09<polygon style=\"fill:#D4E1F4;\" points=\"285.78,133.225 155.168,263.837 82.025,191.217 111.805,161.96 155.168,204.801    256.001,103.968  \"/>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a<g>\x0a</g>\x0a</svg>";
  var chooseSvg = function (status) {
      if (status instanceof Rejected) {
          return fail;
      };
      if (status instanceof Discussion) {
          return warning;
      };
      if (status instanceof Accepted) {
          return check;
      };
      throw new Error("Failed pattern match at Grid.E (line 136, column 20 - line 139, column 24): " + [ status.constructor.name ]);
  };
  var renderStatusBar = function (v) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.classes([ "prop-status-item" ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ "prop-status-link" ]), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("prop-status-link-text") ])([ Halogen_HTML_Core.text(v.value0) ]), Icon.mkIcon(chooseSvg(v.value1))([  ]) ]) ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-item-tall" ]) ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("GHC Proposals Status") ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "prop-status-list" ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(renderStatusBar)(getProposalsPage(state)))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("button-group") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("button"), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(PrevPage.value);
      }) ])([ Icon.mkIcon(prevSvg)([  ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("button"), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(NextPage.value);
      }) ])([ Icon.mkIcon(nextSvg)([  ]) ]) ]) ])) ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
...
(function($PS) {
  ...
  var Data_Symbol = $PS["Data.Symbol"];
  var Data_Unit = $PS["Data.Unit"];
  var Grid_A = $PS["Grid.A"];
  var Grid_B = $PS["Grid.B"];
  var Grid_C = $PS["Grid.C"];
  var Grid_D = $PS["Grid.D"];
  var Grid_E = $PS["Grid.E"];
  var Halogen_Component = $PS["Halogen.Component"];
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          ...
          if (v instanceof ToggleB) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $14 = {};
                  for (var $15 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $15)) {
                          $14[$15] = oldState[$15];
                      };
                  };
                  $14.aIsActive = false;
          ...
          if (v instanceof ToggleD) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (oldState) {
                  var $20 = {};
                  for (var $21 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $21)) {
                          $20[$21] = oldState[$21];
                      };
                  };
                  $20.aIsActive = false;
          ...
          throw new Error("Failed pattern match at Grid (line 93, column 16 - line 121, column 27): " + [ v.constructor.name ]);
      };
  };
  var _e = Data_Symbol.SProxy.value;
  var _d = Data_Symbol.SProxy.value;
  var _c = Data_Symbol.SProxy.value;
  var _b = Data_Symbol.SProxy.value;
  var _a = Data_Symbol.SProxy.value;
  var render = function (state) {
      return Halogen_HTML_Elements.main([ Halogen_HTML_Properties.class_("grid-container") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "a";
      }))(Data_Ord.ordInt)(_a)(1)(Grid_A.component)(state.aIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleA.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "b";
      }))(Data_Ord.ordInt)(_b)(2)(Grid_B.component)(state.bIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleB.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "c";
      }))(Data_Ord.ordInt)(_c)(3)(Grid_C.component)(state.cIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleC.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "d";
      }))(Data_Ord.ordInt)(_d)(4)(Grid_D.component)(state.dIsActive)(function (msg) {
          return new Data_Maybe.Just(ToggleD.value);
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "e";
      }))(Data_Ord.ordInt)(_e)(5)(Grid_E.component)(Data_Unit.unit)(function (v) {
          return Data_Maybe.Nothing.value;
      }) ]);
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Navbar.Switch"] = $PS["Navbar.Switch"] || {};
  var exports = $PS["Navbar.Switch"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Effect_Class = $PS["Effect.Class"];
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $8.isLight = !st.isLight;
              return $8;
          }))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Effect_Console.log("Hello from switch. Talking to navbar.")))(function () {
                  return Halogen_Query_HalogenM.raise(Toggled.value);
              });
          });
      };
  };
  ...
  var render = function (state) {
      ...
      var modeIcon = (function () {
          if (state.isLight) {
              return Svg_Renderer_Halogen.icon(state.darkSvg)([ className("icon") ]);
          };
          return Svg_Renderer_Halogen.icon(state.lightSvg)([ className("icon") ]);
      })();
      return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link"), Halogen_HTML_Properties.href("#"), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(Toggle.value);
      }) ])([ modeIcon, Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("link-text") ])([ Halogen_HTML_Core.text(modeText) ]) ]);
  };
  var component = function (dictMonadEffect) {
      return Halogen_Component.mkComponent({
          initialState: initialState,
...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Icon = $PS["Icon"];
  var Navbar_Switch = $PS["Navbar.Switch"];                
  var ViewModeToggled = (function () {
      function ViewModeToggled() {

      };
      ViewModeToggled.value = new ViewModeToggled();
      return ViewModeToggled;
  })();
  var HandleSwitch = (function () {
      function HandleSwitch(value0) {
          this.value0 = value0;
      };
      HandleSwitch.create = function (value0) {
          return new HandleSwitch(value0);
      };
      return HandleSwitch;
  })();
  var sunSvg = "<svg xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" data-prefix=\"fas\" data-icon=\"sun\" class=\"svg-inline--fa fa-sun fa-w-16\" role=\"img\" viewBox=\"0 0 512 512\"><path fill=\"currentColor\" d=\"M256 160c-52.9 0-96 43.1-96 96s43.1 96 96 96 96-43.1 96-96-43.1-96-96-96zm246.4 80.5l-94.7-47.3 33.5-100.4c4.5-13.6-8.4-26.5-21.9-21.9l-100.4 33.5-47.4-94.8c-6.4-12.8-24.6-12.8-31 0l-47.3 94.7L92.7 70.8c-13.6-4.5-26.5 8.4-21.9 21.9l33.5 100.4-94.7 47.4c-12.8 6.4-12.8 24.6 0 31l94.7 47.3-33.5 100.5c-4.5 13.6 8.4 26.5 21.9 21.9l100.4-33.5 47.3 94.7c6.4 12.8 24.6 12.8 31 0l47.3-94.7 100.4 33.5c13.6 4.5 26.5-8.4 21.9-21.9l-33.5-100.4 94.7-47.3c13-6.5 13-24.7.2-31.1zm-155.9 106c-49.9 49.9-131.1 49.9-181 0-49.9-49.9-49.9-131.1 0-181 49.9-49.9 131.1-49.9 181 0 49.9 49.9 49.9 131.1 0 181z\"/></svg>";
  var renderListItem = function (v) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link"), Halogen_HTML_Properties.href("#") ])([ Icon.mkIcon(v.value0)([ Icon.className("icon") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("link-text") ])([ Halogen_HTML_Core.text(v.value1) ]) ]) ]);
  };
  var renderListHeader = function (x) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("logo") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link"), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "link-text", "logo-text" ]) ])([ Halogen_HTML_Core.text("YAYHASKELL") ]), Icon.mkIcon(x)([ Icon.className("icon") ]) ]) ]);
  };
  var profIcon = "<svg xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" data-prefix=\"fas\" data-icon=\"user\" class=\"svg-inline--fa fa-user fa-w-14\" role=\"img\" viewBox=\"0 0 448 512\"><path fill=\"currentColor\" d=\"M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z\"/></svg>";
  var postIcon = "<svg xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" data-prefix=\"fas\" data-icon=\"pen\" class=\"svg-inline--fa fa-pen fa-w-16\" role=\"img\" viewBox=\"0 0 512 512\"><path fill=\"currentColor\" d=\"M290.74 93.24l128.02 128.02-277.99 277.99-114.14 12.6C11.35 513.54-1.56 500.62.14 485.34l12.7-114.22 277.9-277.88zm207.2-19.06l-60.11-60.11c-18.75-18.75-49.16-18.75-67.91 0l-56.55 56.55 128.02 128.02 56.55-56.55c18.75-18.76 18.75-49.16 0-67.91z\"/></svg>";
  var moonSvg = "<svg xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" data-prefix=\"fas\" data-icon=\"moon\" class=\"svg-inline--fa fa-moon fa-w-16\" role=\"img\" viewBox=\"0 0 512 512\"><path fill=\"currentColor\" d=\"M283.211 512c78.962 0 151.079-35.925 198.857-94.792 7.068-8.708-.639-21.43-11.562-19.35-124.203 23.654-238.262-71.576-238.262-196.954 0-72.222 38.662-138.635 101.498-174.394 9.686-5.512 7.25-20.197-3.756-22.23A258.156 258.156 0 0 0 283.211 0c-141.309 0-256 114.511-256 256 0 141.309 114.511 256 256 256z\"/></svg>";
  var logo = "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" version=\"1.1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 1000 1000\" enable-background=\"new 0 0 1000 1000\" xml:space=\"preserve\">\x0a<g><path d=\"M413.5,154.1l461.2,691.8H701.8L557.7,629.7L413.5,845.9H240.6L471.2,500L240.6,154.1H413.5z M182.9,154.1H10L240.6,500L10,845.9h172.9L413.5,500L182.9,154.1z M605.7,355.9l76.9,115.3H990V355.9L605.7,355.9z M797.8,644.1H990V528.8l-269,0L797.8,644.1z\"/></g>\x0a</svg>";
  var initialState = function (v) {
      return {
          switchState: Data_Maybe.Just.create({
              isLight: true,
              lightSvg: sunSvg,
              darkSvg: moonSvg
          })
  ...
  var helpIcon = "<svg xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" data-prefix=\"fas\" data-icon=\"question\" class=\"svg-inline--fa fa-question fa-w-12\" role=\"img\" viewBox=\"0 0 384 512\"><path fill=\"currentColor\" d=\"M202.021 0C122.202 0 70.503 32.703 29.914 91.026c-7.363 10.58-5.093 25.086 5.178 32.874l43.138 32.709c10.373 7.865 25.132 6.026 33.253-4.148 25.049-31.381 43.63-49.449 82.757-49.449 30.764 0 68.816 19.799 68.816 49.631 0 22.552-18.617 34.134-48.993 51.164-35.423 19.86-82.299 44.576-82.299 106.405V320c0 13.255 10.745 24 24 24h72.471c13.255 0 24-10.745 24-24v-5.773c0-42.86 125.268-44.645 125.268-160.627C377.504 66.256 286.902 0 202.021 0zM192 373.459c-38.196 0-69.271 31.075-69.271 69.271 0 38.195 31.075 69.27 69.271 69.27s69.271-31.075 69.271-69.271-31.075-69.27-69.271-69.27z\"/></svg>";
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Effect_Console.log("Hello from navbar. Talking to main.")))(function () {
              return Halogen_Query_HalogenM.raise(ViewModeToggled.value);
          });
      };
  };
  var _switch = Data_Symbol.SProxy.value;
  var render = function (dictMonadEffect) {
      return function (state) {
          return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_("navbar") ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("navbar-nav") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.cons(renderListHeader(logo))(Data_Functor.map(Data_Functor.functorArray)(renderListItem)([ new Data_Tuple.Tuple(homeIcon, "Home"), new Data_Tuple.Tuple(profIcon, "Profile"), new Data_Tuple.Tuple(postIcon, "Post"), new Data_Tuple.Tuple(helpIcon, "Help") ])))([ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "switch";
          }))(Data_Ord.ordInt)(_switch)(1)(Navbar_Switch.component(dictMonadEffect))(Data_Unit.unit)(function (msg) {
              return Data_Maybe.Just.create(new HandleSwitch(msg));
          }) ]) ])) ]);
      };
  };
  var component = function (dictMonadEffect) {
...
(function($PS) {
  ...
  "use strict";
  $PS["Script"] = $PS["Script"] || {};
  var exports = $PS["Script"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
  var html = Halogen_HTML_Elements.script([ Halogen_HTML_Properties.src("bundle.js") ])([  ]);
  var component = function (renderHtml) {
      return Halogen_Component.mkComponent({
...
})(PS["ToggleViewMode"] = PS["ToggleViewMode"] || {});
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["ToggleViewMode"] = $PS["ToggleViewMode"] || {};
  var exports = $PS["ToggleViewMode"];
  var $foreign = $PS["ToggleViewMode"];
  exports["toggleViewMode"] = $foreign.toggleViewMode;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var Navbar = $PS["Navbar"];
  var Script = $PS["Script"];
  var ToggleViewMode = $PS["ToggleViewMode"];                
  var main = (function () {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Navbar.component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body))(function (io) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Grid.component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body))(function () {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Script.component(Script.html))(Data_Unit.unit)(body))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(io.subscribe(Control_Coroutine.consumer(Effect_Aff.monadAff)(function (v) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(ToggleViewMode.toggleViewMode))(function () {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Maybe.Nothing.value);
                          });
                      })))(function () {
